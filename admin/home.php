            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        $qry = $conn->query("SELECT * FROM blood_inventory_new ");
                            ...
                            <div class="card">
                                <div class="card-body bg-light">
                                    <div class="card-body text-dark">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM blood_request_new where date(request_date) = '".date("g:i A l jS F Y")."' and status = 0 ")->num_rows ?>
                                        </b></h4>
                            ...
                            <div class="card">
                                <div class="card-body bg-light">
                                    <div class="card-body text-dark">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM blood_request_new where date(approved_date) = '".date("g:i A l jS F Y")."' and status = 1 ")->num_rows ?>
                                        </b></h4>
