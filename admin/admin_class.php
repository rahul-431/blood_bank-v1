	...
	function save_donation(){
		...
		$data .= ", date_created = '$date_created' ";
			...
			if(empty($id)){
				...
				$save1=$this->db->query("update blood_inventory_new set volume=(select volume from blood_inventory_new where blood_group='$blood_group')+$volume where blood_group='$blood_group'");
			}else{
